...
from google.apps.script.type.types import addon_widget_set
...
from google.cloud.gsuiteaddons_v1.services.g_suite_add_ons import GSuiteAddOnsAsyncClient
from google.cloud.gsuiteaddons_v1.services.g_suite_add_ons import GSuiteAddOnsClient
from google.cloud.gsuiteaddons_v1.services.g_suite_add_ons import pagers
from google.cloud.gsuiteaddons_v1.services.g_suite_add_ons import transports
...
@pytest.mark.parametrize("client_class", [
    GSuiteAddOnsClient, GSuiteAddOnsAsyncClient
])
@mock.patch.object(GSuiteAddOnsClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GSuiteAddOnsClient))
@mock.patch.object(GSuiteAddOnsAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(GSuiteAddOnsAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (GSuiteAddOnsClient, transports.GSuiteAddOnsGrpcTransport, "grpc", grpc_helpers),
    (GSuiteAddOnsAsyncClient, transports.GSuiteAddOnsGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_get_authorization_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_get_authorization") as post, \
         mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "pre_get_authorization") as pre:
...
def test_create_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_create_deployment") as post, \
         mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "pre_create_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_replace_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_replace_deployment") as post, \
         mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "pre_replace_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_get_deployment") as post, \
         mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "pre_get_deployment") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_deployments_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_list_deployments") as post, \
         mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "pre_list_deployments") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "pre_delete_deployment") as pre:
        pre.assert_not_called()
...
def test_install_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "pre_install_deployment") as pre:
        pre.assert_not_called()
...
def test_uninstall_deployment_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "pre_uninstall_deployment") as pre:
        pre.assert_not_called()
...
def test_get_install_status_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "post_get_install_status") as post, \
         mock.patch.object(transports.GSuiteAddOnsRestInterceptor, "pre_get_install_status") as pre:
        pre.assert_not_called()
        post.assert_not_called()
