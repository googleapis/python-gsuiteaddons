...
class GSuiteAddOnsTransport(abc.ABC):
    """Abstract transport class for GSuiteAddOns."""

    AUTH_SCOPES = (
        'https://www.googleapis.com/auth/cloud-platform',
    )

    DEFAULT_HOST: str = 'gsuiteaddons.googleapis.com'
    def __init__(
            self, *,
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_authorization: gapic_v1.method.wrap_method(
            ...
            self.replace_deployment: gapic_v1.method.wrap_method(
            ...
            self.install_deployment: gapic_v1.method.wrap_method(
                self.install_deployment,
                default_timeout=None,
                client_info=client_info,
            ),
            self.uninstall_deployment: gapic_v1.method.wrap_method(
                self.uninstall_deployment,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_install_status: gapic_v1.method.wrap_method(
